...
Thanks for your interest in contributing to Coding! This document provides guidelines for contributing to the project.

## Ways to Contribute

### Reporting Bugs

Before creating a bug report, please check [existing issues](https://github.com/lml2468/coding/issues) to avoid duplicates.

When reporting a bug, include:
- Coding version (`coding --version`)
...
2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/Coding.git
   cd Coding
   ```
...
├── .coding/               # Coding workflow (project's own) ←
│   ├── scripts/            # Bash scripts
│   └── spec/               # Spec file templates
└── docs/                   # Documentation
```

> **Important:** When modifying `.claude/` or `.coding/`, check if the same changes need to be applied to `src/templates/`. The project uses its own config files, but templates are what gets installed to user projects.
...
Every contribution helps make Coding better. We appreciate your time and effort!
