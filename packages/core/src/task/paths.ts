 ...
 * `.coding/scripts/common/task_store.py::cmd_create`:
 *
 *     <tasks-dir>/05-13-coding-core-sdk-package/
 *
 * Coding also creates system onboarding tasks during `coding init` using a
...
export interface TaskDirParts {
  /**
   * The directory prefix. Dated tasks use `MM-DD`; Coding system onboarding
   * tasks use `00`.
   */
  prefix: string;
