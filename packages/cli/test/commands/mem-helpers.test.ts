/**
 * Tier-1 unit tests for the `coding mem` CLI-layer helpers.
 *
 * The reusable retrieval / search / cleaning primitives moved to
 * `@limenglin/coding-core/mem` and are covered by `packages/core/test/mem/*`.
...
describe("buildFilter", () => {
  ...
  it("accepts claude as a platform filter", () => {
    const f = buildFilter({ platform: "claude", global: true });
    expect(f.platform).toBe("claude");
