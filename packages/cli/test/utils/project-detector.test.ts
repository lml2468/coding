...
describe("detectProjectType", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "coding-detect-"));
  });
...
describe("detectMonorepo", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "coding-monorepo-"));
  });
...
describe("detectMonorepo polyrepo fallback", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "coding-poly-"));
  });
