...
export async function writeFile(
  ...
  if (existingContent === content) {
    ...
    // byte-identical to a Coding template and still not be Coding-owned.
    return false;
  }
  ...
  if (mode === "skip") {
    ...
    // Skipped: coding did NOT write this file — caller should not track it
  ...
  if (mode === "append") {
    ...
    // Append: coding added coding content to a user-owned file. Tracking
