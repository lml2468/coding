/**
 * mem.ts — CLI wrapper over `@limenglin/coding-core/mem`.
 *
 ...
 *
 * Run `coding mem help` for the full flag reference.
 */
...
import {
  ...
  readMemContext,
  searchMemSessions,
} from "@limenglin/coding-core/mem";
import type {
  MemFilter,
  MemPhase,
  MemSessionInfo,
...
const VALID_PLATFORMS: readonly string[] = ["claude", "all"];
...
function cmdHelp(): void {
  console.log(`coding mem — list/search Claude sessions
...
flags:
  ...
  --phase brainstorm|implement|all       extract: slice by Coding brainstorm windows
...
examples:
  coding mem list
  coding mem list --global --platform claude --since 2026-04-01
  coding mem search "session insight" --global
  coding mem extract 5842592d --grep memory
