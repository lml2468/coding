/**
 * Path constants for coding workflow structure
 *
...
export const DIR_NAMES = {
  ...
  WORKFLOW: ".coding",
  /** Workspace directory (under .coding/) - developer work areas */
  WORKSPACE: "workspace",
  /** Tasks directory (under .coding/) - unified task storage */
  TASKS: "tasks",
  /** Archive directory (under tasks/) */
  ARCHIVE: "archive",
  /** Spec/guidelines directory (under .coding/) */
  SPEC: "spec",
  /** Scripts directory (under .coding/) */
  SCRIPTS: "scripts",
} as const;
 ...
 * @example getWorkspaceDir("john") => ".coding/workspace/john"
 */
 ...
 * @example getTaskDir("01-21-my-task") => ".coding/tasks/01-21-my-task"
 */
 ...
 * @example getArchiveDir() => ".coding/tasks/archive"
 */
