 ...
 * - src/templates/coding/ - Workflow scripts and config
 ...
 *
 * Note: We NO LONGER copy from the project's own .coding/, .cursor/, .claude/
 * because those may be customized for the Coding project itself.
 */
